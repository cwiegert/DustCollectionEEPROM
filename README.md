...
Here is an example of the work and a demonstration of the bracket, servo, arm and .... unfortulately,.... the gates sticking. [prototype video] (https://github.com/cwiegert/DustCollectionEEPROM/blob/main/DustCollection_v61_10_18_2021/Gates%20prototype.MOV)   Because of the size of the movie, the link won't automatically play, but you can download for any play which support .MP4 playback.  

Each of the [servo's](https://www.amazon.com/gp/product/B08KDW4757/ref=ppx_yo_dt_b_search_asin_image?ie=UTF8&th=1) are mounted with the [hanger](https://www.amazon.com/gp/product/B07Q2VP8P4/ref=ppx_yo_dt_b_asin_title_o05_s00?ie=UTF8&psc=1) and  will connect to a pin set on the [PWM Contoller](https://www.amazon.com/gp/product/B01D1D0CX2/ref=ppx_yo_dt_b_asin_title_o02_s01?ie=UTF8&psc=1).   ![image](https://github.com/cwiegert/DustCollectionEEPROM/assets/33184701/37dfbf4e-9c02-49f6-9474-0c7f14701a1d)
